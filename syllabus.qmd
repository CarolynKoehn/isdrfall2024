...
If you want to start learning a few of the basics, the [Resources](/resource/index.html) tab has some background information to get you started. Note that this is not an exhaustive list - the number of new `R` tutorials available on the internet seems to be growing exponentially.
...
4. __Ask me!__ Sign up for a time to meet with me during student hours at <https://calendly.com/carolynkoehn-u>. I'll want to know what searches you've tried (so I don't chase down answers that you've already seen) and what approaches you've tried and why they haven't worked. Remember, I'm here to help (but not write your code for you).
...
The [schedule page](/schedule.html) provides an overview of what to expect each week.
...
**Final Project (50pts): ** The final project asks you to conduct an entire spatial analysis from layout to results. Grades on the final project are based on your objectives and your self-assessment of whether or not you achieved those objectives. Your first draft of the final project will be due __December 5__. I'll make comments based on the same categories for the homework revision and you'll have time to revise your submission prior to the final deadline of __December 14__. <!-- check dates -->

You can find descriptions for all the assignments on the [assignments page](/assignment/index.html).
