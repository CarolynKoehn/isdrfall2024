...
subtitle: "HES 505 Fall 2024: Session 7"
...
1. Create a vector object for Owyhee county in Idaho (hint: use `filter`).
2. Owyhee county is in Idaho and borders Oregon. Which two predicates communicate this information? Show your code and output.
3. Print the bounding box information for Oregon and Owyhee county. Which part of this output could clue you in that they border each other?
