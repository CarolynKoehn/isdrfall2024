...
![](img/slide_3/vector_data_types.png)
::: footer
Image Source: [Data Carpentry: Geospatial Concepts](https://datacarpentry.org/organization-geospatial/02-intro-vector-data.html)
:::
