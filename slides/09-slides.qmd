...
subtitle: "HES 505 Fall 2024: Session 9"
...
library(viridis)
library(terra)
cejst <- sf::read_sf("../../data/2023/assignment01/cejst_nw.shp") %>% 
  filter(!st_is_empty(.))
  

wildfire.haz <- terra::rast("../../data/2023/assignment01/wildfire_hazard_agg.tif")

land.use <- project(terra::rast("../../data/2023/assignment05/land_use_pnw.tif"), wildfire.haz)
