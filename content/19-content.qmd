...
- <i class="fas fa-external-link-square-alt"></i> [Ch. 14: Spatial Interpolation](https://mgimond.github.io/Spatial/spatial-interpolation.html) in
Manuel Gimond's Introduction to GIS and Spatial Analysis `bookdown` project provides more examples of interpolation, trend surfaces, and kriging.
